...
if($painel->CadBanner($nome, $files['tmp_name'], $files['name'])){
echo "<div class='alert alert-success' role='alert'><b>Cadastrado!</b> <img src='img/load.gif'></div>";
...
<h1 style="font-family:inter">GERENCIAR BANNER</h1>
...
<?php
$sql = BD::conn()->prepare(" SELECT * FROM banners ORDER by id DESC");
$sql->execute();
if ($sql->rowCount() == 0) {
...
<td><img class="Foto" src="../assets/img_banner/<?php echo $row->foto;?>"></td>
<td><?php echo $row->nome;?></td>
<td><a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#desativar<?php echo $row->id;?>"><i class="fas fa-ban"></i></a></td>

</tr>

<!-- excluir -->
<div class="modal fade" id="desativar<?php echo $row->id;?>">
...
<input name="nome" class="form-control form-control" maxlenght='15' style="height:45px" required />
