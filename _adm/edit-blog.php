        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="col-sm-6">
                        <h1 style="font-family:inter; text-transform:uppercase">Editar Post</h1>
                    </div>
            ...
            if (isset($_POST['acao']) && $_POST['acao'] == 'cadastrar') {
              ...
              $descricao = $_POST['descricao'];
                ...
                if($titulo == ''){
                    echo "<div class='alert alert-danger' role='alert'>Nome do Post obrigatório.</div>";
                    }else{
                    try {	
                    
                    
                    $editar = BD::conn()->prepare("UPDATE blog SET 
...
$sql = BD::conn()->prepare ("SELECT * FROM blog WHERE id_produto = ".$id." ");
 $sql->execute();
 if($sql->rowCount() == 0){
 echo "";
 }else{	
...
?>
 ...
 <?php 
 $sq = BD::conn()->prepare ("SELECT c.id_blog, c.categoria, e.id_produto, e.categoria_prod
  FROM cat_blog c join blog e ON e.categoria_prod = c.id_blog WHERE id_produto = ".$id." ");
 $sq->execute();
 if($sq->rowCount() == 0){
 echo "";
 }else{	
...
<option value="<?php echo $result->id_blog;?>">-- <?php echo $result->categoria;?> --</option>                               
<?php }}?>                                  



<?php 
 $sq = BD::conn()->prepare ("SELECT * FROM cat_blog order by categoria ASC");
 $sq->execute();
 if($sq->rowCount() == 0){
 echo "";
 }else{	
...
<?php }}?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <label class="titulo">NOME DO POST</label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <label class="titulo">DESCREVA O POST</label>
