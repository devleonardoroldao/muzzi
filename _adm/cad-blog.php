                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['acao']) && $_POST['acao'] == 'cadastrar') {
                        ...
                        if ($files == '') {
                            ...
                            if ($painel->CadBlog($categoria_prod, $titulo, $slug, $descricao_curta, $desconto, $descricao, $files['tmp_name'], $files['name'])) {
                    ...
                    <div class="col-sm-6">
                        ...
                        <h1 style="font-family:inter">CADASTRAR BLOG</h1>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped projects" style="font-size:13px">
                            ...
                            <tbody>
                                ...
                                <?php
                                $sql = BD::conn()->prepare(" SELECT * FROM blog ORDER by id_produto DESC");
                                $sql->execute();
                                if ($sql->rowCount() == 0) {
                                ...
                                ?>
                                    <tr>
                                        <?php while ($row = $sql->fetchObject()) { ?>
                                            <td><img class="Foto" src="../assets/img_blog/<?php echo $row->img; ?>"></td>
                                            ...
                                            <td><a class="btn btn-success btn-sm" href="edit-blog.php?id_produto=<?php echo $row->id_produto; ?>"><i class="fas fa-edit"></i></a></td>
                                    ...
                                    <div class="modal fade" id="desativar<?php echo $row->id_produto; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="remove-blog.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    ?>
                                            ...
                                            <option value="<?php echo $resultado->id_blog; ?>"><?php echo $resultado->categoria; ?></option>
