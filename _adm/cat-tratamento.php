...
<title>Cadastrar Categoria Serviço</title>
...
<div class="col-sm-12">
<h1 style="font-family:inter; text-transform:uppercase">Cadastrar Categoria Serviço</h1>
</div>
...
if($painel->Cadcat_tratamento($categoria, $slug)){
...
<table class="table table-striped projects" style="font-size:13px">
                            ...
                            <tbody>
                                ...
                                <?php
                                $sql = BD::conn()->prepare(" SELECT * FROM cat_tratamento ORDER by categoria ASC");
                                $sql->execute();
                                if ($sql->rowCount() == 0) {
                                ...
                                ?>
                                    <tr>
                                        <?php while ($row = $sql->fetchObject()) { ?>
                                            ...
                                            <td><a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#desativar<?php echo $row->id_tratamento; ?>"><i class="fas fa-ban"></i></a></td>

                                    </tr>

                                    <!-- excluir -->
                                    <div class="modal fade" id="desativar<?php echo $row->id_tratamento; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="remove-cat-tratamento.php" method="post">
                                                    <div class="modal-footer justify-content-between" style="background:#f1f1f1">
                                                        ...
                                                        <input name="id_tratamento" value="<?php echo $row->id_tratamento; ?>" type="hidden">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
